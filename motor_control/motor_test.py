...
class TurnigyESC:
    ...
    def calibrate(self) -> None:
        ...
        """
        print("Calibrating...")
        self.pwm(width=self.MIN_WIDTH)
        input("Connect power and press Enter to calibrate...")
        self.pwm(width=self.MIN_WIDTH, snooze=2)   # Official docs: "about 2 seconds".
        self.pwm(width=self.MAX_WIDTH, snooze=2)   # Time enough for the cell count, etc. beeps to play.
        self.pwm(width=self.DEFAULT_WIDTH)
